...
export default function SlugPage() {
  ...
  // Se la pagina è ancora in fase di caricamento, mostra lo spinner
  if (router.isFallback) {
    return (
      <div style={{ fontFamily: 'Arial, sans-serif', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column', textAlign: 'center', backgroundColor: '#f8f9fa' }}>
        ...
        <p style={{ color: '#4a5568', fontSize: '1.2rem' }}>Caricamento...</p>
      </div>
    );
  }

  // Una volta che la pagina è pronta, mostra il contenuto
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column', textAlign: 'center', backgroundColor: '#f8f9fa' }}>
